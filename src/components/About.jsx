  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <div className="w-full px-4 md:px-8 py-8">
            <img src={aboutImg} alt="Me developing this page" className="w-xl rounded-2xl mt-10 float-left px-3"/>
        ...
        <div className="w-full px-4 md:px-8 py-8">
            <img src={cspImg} alt="Clip Studio Paint" className="w-xl rounded-2xl mt-10 float-right px-3"/>
            <p className='mt-10 text-lg text-center text-neutral-500 leading-relaxed'>
        ...
        <div className="w-full px-4 md:px-8 py-8">
            <img src={flImg} alt="FL Studio" className="w-xl rounded-2xl mt-10 float-left px-3"/>
            <p className='mt-10 text-lg text-center text-neutral-500 leading-relaxed'>
        ...
        <div className="w-full px-4 md:px-8 py-8">
            <img src={blenderImg} alt="Blender" className="w-xl rounded-2xl mt-10 float-right px-3"/>
            <p className='mt-10 text-lg text-center text-neutral-500 leading-relaxed'>
